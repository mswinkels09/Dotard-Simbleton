const businesses = [
  ...
  let agentInfo = businesses.map(businessObject => { 
  return {
  agentFirstName: businessObject.purchasingAgent.nameFirst, 
  agentLastName: businessObject.purchasingAgent.nameLast,
  agentCompanyName: businessObject.companyName,
  agentPhone: businessObject.phoneWork
}
})

export const agentNames = () => {
  return agentInfo.slice()
}
